...
tickers = {260105:'BANKNIFTY', 13613826: 'BANKNIFTY21JULFUT', 12417538: 'BANKNIFTY21JUNFUT'}
...
def on_ticks(ws, ticks):
    ...
    for tick in ticks: 
        ...
        if(len(ticks210[instrument_token]) == 210):
            ...
            candle_df['rsi13'] = talib.RSI(candle_df[instrument_token]['close'], timeperiod=13)
            candle_df['rsi21'] = talib.RSI(candle_df[instrument_token]['close'], timeperiod=21)
            candle_df['rsi34'] = talib.RSI(candle_df[instrument_token]['close'], timeperiod=34)
            candle_df['ema21'] = talib.EMA(candle_df[instrument_token]['close'], timeperiod=21)
            candle_df['wma21'] = talib.WMA(candle_df[instrument_token]['close'], timeperiod=21)
