...
def on_ticks(ws, ticks):
    ...
    for tick in ticks:
        ...
        if(len(ticks144[instrument_token]) == 144):
            ...
            ### 21 Period Brakeout Strategy
            if ticker_data['21_period_high'] < candle_close:
                buy(instrument_token)
                print("Candle closed below 21 period high")
            elif ticker_data['21_period_low'] > candle_close:
                sell(instrument_token)
                print("candle closed below 21 period low")
